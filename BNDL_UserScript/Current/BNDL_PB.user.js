...
(async function() {
    ...
    $(maindiv).attr("id", 'bndl').css({position:'fixed',top:'50%',left:'50%',transform:'translate(-50%, -50%)',minWidth:'300px', minHeight:'150px', width:'10vw', height:'5vh', backgroundColor:'lightgrey'}).hide();
    ...
    $(bndlBTN).attr("id", 'bndl4')
		.attr("data-default-text", "BNDL")
		.attr("disabled", "true")
		.addClass('btn-primary')
		.addClass('disabled')
		.text('BNDL');
    const quaBTN = btn_obj.cloneNode();
    $(quaBTN).addClass('btn-danger')
		.attr("data-default-text", "Quality")
		.attr("data-now-text", 'Quality('+quality*100+')')
