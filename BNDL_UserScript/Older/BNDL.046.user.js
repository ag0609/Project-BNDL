...
(function() {
    ...
    style.type = 'text/css';
    style.innerHTML = 'button .bndl-btn {background-color:white;height:5%} #bndl {transition:all 1s;} #bndl.close {top:95%;left:90%;width:10%;height:5%;} #bndl.open {top:40%;left:35%;width:30%;height:20%;} #bndl.extend {top:0;left:0;width:100%;height:100%;}';
    ...
    function create_btn() {
        ...
        document.getElementById('bndl').classList.toggle('open');
