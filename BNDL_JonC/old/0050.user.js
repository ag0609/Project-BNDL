...
(function() {
    ...
    bndlBTN.innerText = 'BNDL';
    bndlBTN.onclick = ()=>{bndlBTN.disabled=true; start=1; firekey(document.getElementById('renderer'), 34);};
    bndlBTN.disabled = true;
    const quaBTN = btn_obj.cloneNode();
    quaBTN.className = 'bndl-btn';
    quaBTN.style.backgroundColor = 'white';
    quaBTN.innerText = 'Quality('+quality*100+')';
    quaBTN.onclick = ()=>{let tmpq = prompt("Quality?(0-100)"); if(tmpq < 100 && tmpq > 0) {quality = tmpq/100;} quaBTN.innerText = 'Quality('+quality*100+')';};
    ...
    (function() {
        ...
        CanvasRenderingContext2D.prototype.drawImage = function() {
            ...
            if(_$canvas[curp] == undefined) {
                if(!start && curp > 1) fireKey(document.getElementById('renderer'), 36);
                _$canvas[curp] = [];
            }
...
//                     console.dir(arguments);
                ...
                _$timer = setTimeout(()=>{
                    ...
                    console.log("size:", img$size[curp]);
                    if(img$size[curp] == img$size[curp-1] && !retry) {
